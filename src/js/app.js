...
function appViewModel() {
  ...
  this.searchLocation = ko.observable('Pittsburgh');
  ...
  this.currentLat = ko.observable(40.440624);
  this.currentLng = ko.observable(-79.995888);
...
// Initialize Google map, perform initial deal search on a city.
  function mapInitialize() {
    city = new google.maps.LatLng(40.440624, -79.995888);
